...
class Base {
    ...
    function sanitize($dataArray) {
		...
		filter_var($this->data['faq_question'],FILTER_SANITIZE_SPECIAL_CHARS);
		
		filter_var($this->data['faq_answer'],FILTER_SANITIZE_SPECIAL_CHARS);
    ...
    function save() {
        ...
        if (empty($this->data[$this->keyField])) {
            ...
            foreach ($this->columnNames as $columnName) {
                $newDataArray[] = $this->data[$columnName];
            }
            
            $isSaved = $stmt->execute(array_values($newDataArray));
